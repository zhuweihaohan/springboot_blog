<%@ page language="java" import="java.util.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			<rapid:override name="frame-content">
				...
				<form class="layui-form" method="post" id="myForm" action="article/update/${article_id}">
					<div class="layui-form-item">
						<label class="layui-form-label">标题 <span style="color: #FF5722;" >*</span></label>	
						<div class="layui-input-block">
							<input type="text" name="articleTitle" lay-verify="title" id="title"
								autocomplete="off" value="${article.getArticleTitle()}" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea  name="articleContent" lay-verify="content" id="content" >${article.getArticleContent()}</textarea>
						</div>
					</div>
