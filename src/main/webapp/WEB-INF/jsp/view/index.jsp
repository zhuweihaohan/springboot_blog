                ...
                <ul style="margin-top: 0px;">
                    <c:forEach items="${noticeList}" var="n">
                        <li class="scrolltext-title">
                            <a href="/admin/showNotice/${n.noticeId}" rel="bookmark">${n.noticeTitle}</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
            ...
            <c:forEach items="${pageInfo.list}" var="a">
                ...
                <article class="post type-post">
                    ...
                    <figure class="thumbnail">
                        <a href="show/${a.articleId}">
                            <img width="280" height="210"
                                 src="/static/img/thumbnail/random/img_${a.articleId%15}.jpg"
                                 class="attachment-content size-content wp-post-image"
                                 alt="${a.articleTitle}">
                        </a>
                     <span class="cat">
                                <a href="/category/find/ ${a.categoryList[0].categoryName}">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">
                            <a href="/article/show/${a.articleId}"
                               rel="bookmark">
                                    ${a.articleTitle}
                            </a>
                        </h2>
