   ...
   <%--  <aside class="widget about">
    ...
    <aside id="php_text-22" class="widget php_text">
        ...
        <div class="textwidget widget-text">
            <ul class="site-profile">
                ...
                <li><i class="fa fa-pencil-square-o"></i> 最后维护时间：
    ...
    <aside class="widget">
        ...
        <div class="tagcloud">
            <c:forEach items="${tagList}" var="tag">
                <a href="/article/findTag/${tag.getTagName()}"
    ...
    <aside id="recent_comments-2" class="widget recent_comments wow fadeInUp" data-wow-delay="0.3s"><h3
        ...
        <div id="message" class="message-widget">
            <ul>
               <c:forEach items="${hotList}" var="m">
                    <li>
                        <a href="/article/show/${m.articleId}" rel="bookmark" title=" (${m.articleCommentCount}条评论)">
                                ${m.articleTitle}
                        </a>
                    </li>
                </c:forEach>
