    ...
    <div id="menu-box">
        <div id="top-menu">
            ...
            <div class="logo-site"><h1 class="site-title">
                ...
                <p class="site-description">简单分享技术</p>
            </div><!-- .logo-site -->
                        ...
                        <ul id="menu-pcmenu" class="down-menu nav-menu sf-js-enabled sf-arrows">
                            ...
                            <c:forEach items="${categoryList1}" var="category">
                                <c:if test="${category.categoryPid==0}">
                                    <li>
                                        <a href="/category/find/${category.getCategoryName()}" >
                                            <i class="${category.categoryIcon}"></i>
                                            <span class="font-text">${category.categoryName}&nbsp;</span>
                                        </a>
                                        <ul class="sub-menu">
                                            <c:forEach items="${categoryList1}" var="cate">
                                                <c:if test="${cate.categoryPid==category.categoryId}">
                                                    <li>
                                                        <a href="/category/find/${cate.getCategoryName()}" >${cate.categoryName}</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
...
<%--                         <li>--%>
<%--                                        <a href="/jsp/view/Page/message.jsp">--%>
...
<div id="search-main">
    <div class="searchbar">
        <form method="get" id="searchform" action="/article/search" accept-charset="UTF-8">
            <span>
                <input type="text" value="" name="q" id="q" placeholder="输入搜索内容"required="">
