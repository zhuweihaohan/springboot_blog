...
(function ($) {
    ...
    function write() {
        var content = "<div class=\"ds-dialog\" id='PAY_" + id + "'>"
            ...
            + "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src='/ssm-blog-luohongde/resources/img/shang/weixinpay.jpg'  />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     <div class=\"qrcode-img qrCode_1\" id=\"qrCode_1\">"
            + "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(102, 153, 204\">"
            + "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\"  src=\"/ssm-blog-luohongde/resources/img/shang/qqpay.jpg\"  />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">"
            + "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(235, 95, 1\">"
            + "       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\"  src=\"http://t.027cgb.com/631114/5FF3FC79B8BEB00D4FE690993E7A2D31.jpg \" />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     </div>"
